...
public class TecnicoService {
	...
	public Tecnico inserir(Tecnico novoTecnico) {
		...
		Preconditions.checkArgument(novoTecnico.getNome()!= null && !novoTecnico.getNome().isEmpty(), "O nome é obrigatorio");
		...
		Preconditions.checkArgument(novoTecnico.getDataDeAdmissao().isBefore(dataAtual) || dataDeAdmissao.equals(dataDeAdmissao)
