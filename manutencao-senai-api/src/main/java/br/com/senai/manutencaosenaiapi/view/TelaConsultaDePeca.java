...
public class TelaConsultaDePeca extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaConsultaDePeca frame = new TelaConsultaDePeca();
	...
	public TelaConsultaDePeca() {
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				table.updateUI();
				JOptionPane.showMessageDialog(getContentPane(), "Peça excluida com sucesso");
			}
		});
				...
				.addGroup(gl_TelaDeConsultaDePeca.createSequentialGroup()
					.addGroup(gl_TelaDeConsultaDePeca.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_TelaDeConsultaDePeca.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(table, GroupLayout.PREFERRED_SIZE, 544, GroupLayout.PREFERRED_SIZE)))
